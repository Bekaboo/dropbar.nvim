...
| Method                                                                                                      | Description                                                                                                                                                                                   |
| ------------------------------------------------                                                            | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dropbar_symbol_t:new(opts: [dropbar_symbol_t](#dropbar_symbol_t)?): [dropbar_symbol_t](#dropbar_symbol_t)` | constructor of `dropbar_symbol_t`                                                                                                                                                             |
...
| `dropbar_menu_entry_t:cat(): string`                                          | concatenate the components into a string, returns the string and highlight info<sub>[`dropbar_menu_hl_info_t`](#dropbar_menu_hl_info_t)                   |
